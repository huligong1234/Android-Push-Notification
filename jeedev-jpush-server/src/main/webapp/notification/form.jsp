...
<tr>
	<td>Title:</td>
	<td><input type="text" id="title" name="title" value="hello world" style="width:380px;" /></td>
</tr>
<tr>
	<td>Message:</td>
	<td><textarea id="message" name="message" style="width:380px; height:80px;" >通知内容</textarea></td>
</tr>
<%--
<tr>
	<td>Ticker:</td>
...
<tr>
	...
	<td><input type="text" id="uri" name="uri" value="" style="width:380px;" />
	    <br/><span style="font-size:0.8em">ex) http://www.badiu.com, geo:37.24,131.86, tel:158-8888-8888</span>
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
