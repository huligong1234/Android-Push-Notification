 ...
 */
package org.jeedevframework.jpush.server.xmpp.router;
...
import org.jeedevframework.jpush.server.xmpp.handler.IQAuthHandler;
import org.jeedevframework.jpush.server.xmpp.handler.IQHandler;
import org.jeedevframework.jpush.server.xmpp.handler.IQRegisterHandler;
import org.jeedevframework.jpush.server.xmpp.handler.IQRosterHandler;
import org.jeedevframework.jpush.server.xmpp.session.ClientSession;
import org.jeedevframework.jpush.server.xmpp.session.Session;
...
public class IQRouter {
    ...
    private void updateNotification(String id,String userName){
    	...
    	if(notificationMO != null){
    		...
    		}else if(NotificationMO.STATUS_RECEIVE.equals(notificationMO.getStatus())){
        		//设置状态为已查看
