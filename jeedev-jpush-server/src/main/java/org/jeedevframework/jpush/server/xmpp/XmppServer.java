 ...
 */
package org.jeedevframework.jpush.server.xmpp;
...
public class XmppServer {
    ...
    public void start() {
        try {
          ...
          //  locateServer();
            ...
            log.info("Jeedev JPush Server v" + version);
    ...
    public boolean isStandAlone() {
        ...
        try {
            standalone = Class
                    .forName("org.jeedevframework.jpush.server.starter.ServerStarter") != null;
